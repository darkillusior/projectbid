          ...
          <div class="flex flex-wrap  items-center justify-center">
            ...
            <div class="w-full lg:w-4/12 px-4 lg:order-1">
              <div class="flex justify-center py-4 lg:pt-4 pt-8">
                ...
                <div class="mr-4 p-3 text-center">
                  <span class="text-xl font-bold block uppercase tracking-wide text-blue-200">10</span><span class="text-sm text-blue-200">Photos</span>
                </div>
                <div class="lg:mr-4 p-3 text-center">
                  <span class="text-xl font-bold block uppercase tracking-wide text-blue-200">89</span><span class="text-sm text-blue-200">Comments</span>
                </div>
              </div>
            </div>
          </div>
